...
import { addUserData } from "../reduxToolkit/userSlice";
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-6">
             <div className="w-full flex justify-end items-center">
                <button className="bg-black text-white py-2 px-3 m-1 w-1/6 rounded-lg " onClick={() => { dispatch(addUserData()); navigate("/") }}>see all users</button>
            </div>
