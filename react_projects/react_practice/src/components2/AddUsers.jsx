...
const AddUsersdata = () => {
    ...
    return (
        <>
            <button onClick={navigate("/chakboxTable")}>chakboxTable</button>
            <div className="w-full flex justify-end items-center">
                <button className="bg-black text-white py-2 px-3 m-1 w-1/6 rounded-lg " onClick={() => navigate("/userdetails")}>add details</button>
            </div>
